...
namespace _291_proj
{
    public class MovieRepository
    {
        ...
        {
            string sql = "SELECT COUNT(1) FROM Movies WHERE MovieID = @movieId";
        ...
        {
            string sql = "SELECT MovieID, Name AS MovieName, Type AS MovieType, DistributionFee, NumCopies AS NumberOfCopies, Rating AS MovieRating FROM Movies";
        ...
        {
            string sql = "SELECT DISTINCT Type FROM Movies ORDER BY Type";
            return DataAccess.ExecuteQuery(sql);
        }
    }
}
